                ...
                <div className="flex-1 text-center md:text-right">
                  ...
                  >
                    <p className="shadow-text">
                      ...
                      logic shines in Competitive Coding. Beyond algorithms,
                      true skill lies in applying pure logic. Cook-Off
                      challenges you to unleash creativity, test your limits,
                      and face fellow coders. Enter the Colosseum of
                      Creativity—where each line of code paves the way to
                      triumph and legacy.
                    </p>
                  </CardItem>
